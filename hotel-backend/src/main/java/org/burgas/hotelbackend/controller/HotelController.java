...
@Controller
@RequestMapping(value = "/hotel-service/hotels")
public class HotelController {
    ...
    public @ResponseBody ResponseEntity<HotelResponse> createOrUpdateHotel(@RequestBody HotelRequest hotelRequest) {
        ...
        return ResponseEntity
                .status(FOUND)
                .contentType(APPLICATION_JSON)
                .location(URI.create("/hotel-service/hotels/by-id?hotelId=" + hotelResponse.getId()))
                .body(hotelResponse);
    }
    ...
    public @ResponseBody ResponseEntity<HotelResponse> createOrUpdateHotelAsync(@RequestBody HotelRequest hotelRequest)
        ...
        return ResponseEntity
                .status(FOUND)
                .contentType(APPLICATION_JSON)
                .location(URI.create("/hotel-service/hotels/by-id/async?hotelId=" + hotelResponse.getId()))
                .body(hotelResponse);
    }
